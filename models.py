...
def init_cnn_1(embedding_matrix, n_vocabulary, n_embedding, n_sequence, n_labels, **kwargs):
    loss = kwargs["loss"]
...
def init_cnn_2(embedding_matrix, n_vocabulary, n_embedding, n_sequence, n_labels, **kwargs):
    loss = kwargs["loss"]
...
def init_bi_lstm_2(embedding_matrix, n_vocabulary, n_embedding, n_sequence, n_labels, **kwargs):
    loss = kwargs["loss"]
...
def init_cnn_bi_lstm_1(embedding_matrix, n_vocabulary, n_embedding, n_sequence, n_labels, **kwargs):
